...
<section class="grid justify-center">
    ...
    <!-- Wrapper for images -->
    <div id="carousel-images" class="flex z-10 transition-transform duration-700 ease-in-out gap-5 max-w-[1200px] mt-5 ">
    ...
    <!-- Indicators -->
    <div class="absolute z-10 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3">
    ...
    <!-- Navigation controls -->
    <button class="absolute top-0 left-0 z-10 flex items-center justify-center h-full px-4 cursor-pointer" onclick="prevSlide()">
    ...
    <button class="absolute top-0 right-0 z-10 flex items-center justify-center h-full px-4 cursor-pointer" onclick="nextSlide()">
        <span class="inline-flex items-center justify-center w-10 h-10 bg-white/30 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
