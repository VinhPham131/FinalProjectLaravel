    ...
    <section class="grid flex-col phone:max-tablet:justify-center tablet:flex phone:max-tablet:border-gray-200 phone:max-tablet:border-b-2 phone:max-tablet:p-4 gap-5 phone:max-tablet:mb-5 phone:max-tablet:w-screen">
      ...
      <form id="search-form" method="GET" action="/shop" class="max-w-[1200px] w-[220px]">
        ...
        <div class="relative phone:max-tablet:start-[40%]">
          <input type="text" placeholder="Search" name="search" value="{{ request('search') }}" id="default-search" class="block w-full p-4 ps-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
...
<div id="checkBoxCategory" class="relative">
  ...
  >
    ...
    <section class="phone:max-tablet:grid phone:max-tablet:justify-center">
      <section class="grid h-full phone:grid-cols-2 phone:max-tablet:justify-center tablet:grid-cols-2 laptop:grid-cols-3 tablet:w-[calc(1200px-650px)] laptop:w-[calc(1200px-370px)] phone:mx-[10px] phone:w-[calc(500px-120px)] gap-2.5">
          ...
          <div class="product-item mb-32 phone:h-[180px] phone:w-[180px] tablet:w-[260px] tablet:h-[260px] shadow-md">
              <a href="{{ route('detail', $item->id) }}">
                  <div class="bg-gray-100 rounded-lg phone:h-[180px] phone:w-[180px] tablet:w-[260px] tablet:h-[260px]">
                      <img src="{{ $item->images->first()->first_url }}" 
                          alt="{{ $item->name }}" 
