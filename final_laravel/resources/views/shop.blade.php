    ...
    <section
      ...
      <section class="select-none phone:max-tablet:grid phone:max-tablet:justify-center">
        <div class="phone:max-tablet:flex gap-3 relative" id="dropdownButton">
          <!-- Shop By -->
          <div id="shopBy"
            class="border border-gray-300 px-5 py-2 phone:max-tablet:mt-10 rounded cursor-pointer text-sm flex justify-between w-[220px] phone:max-tablet:w-full phone:max-tablet:max-w-[180px]">
            Shop By
            <img width="10"
          ...
          <!-- Sort By -->
          <div id="sortBy"
            class="border border-gray-300 px-5 py-2 mt-10 rounded cursor-pointer text-sm flex justify-between w-[220px] phone:max-tablet:w-full phone:max-tablet:max-w-[180px]">
            Sort By
            <img width="10"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/e94ec9341bd16f6adc455126d5a4c0f9b93274f8dd2680479859e3afea8c2f6a?apiKey=e8ca62b583f64a60ba17a0d16e44846a&"
              alt="Dropdown Icon" />
          ...
          <div id="dropdownSort"
            class="hidden rounded border border-gray-300 bg-white absolute top-[130px] phone:max-tablet:top-[110px] w-[220px] phone:max-tablet:w-full phone:max-tablet:max-w-[180px] shadow-md z-10">
