<div>
    @if (!$isVerified)
        <div class="sticky z-20 top-0 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 phone:max-tablet:mb-10 phone:max-tablet:border-b-0 tablet:mx-auto tablet:max-w-[1200px] phone:mx-[10px] tablet:w-full laptop:w-[calc(100%-100px)]"
            role="alert">
